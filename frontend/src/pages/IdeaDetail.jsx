...
const IdeaDetail = () => {
  ...
  // 2. Wrapped loadData in useCallback with [id] dependency
  ...
  // 3. Moved useEffect below loadData and kept [loadData] dependency
  useEffect(() => {
    loadData();
  }, [loadData]);
  ...
  const rm = roadmap || {
      ...
      steps: [
        {
          ...
          description:
            "Talk to 15–20 people in your target market about their problems and willingness to pay.",
          estimatedDays: 3,
        },
        {
          order: 2,
          ...
          description:
            "Offer your product or service to 5 people at a small price to test real demand.",
          estimatedDays: 7,
        },
        {
          order: 3,
          ...
          description:
            "Use feedback to improve your product, pricing, and positioning before scaling.",
          estimatedDays: 3,
        },
      ],
    },
      ...
      recommendedTools: [
        {
          ...
          purpose: "Customer orders & communication",
          cost: "Free",
        },
        {
          name: "Google Sheets",
          purpose: "Track orders, expenses & revenue",
          cost: "Free",
        },
        {
          name: "Canva",
          purpose: "Marketing materials & social posts",
          cost: "Free",
        },
        {
          name: "Paytm/PhonePe",
          purpose: "Accept digital payments",
          cost: "Free",
        },
      ],
    },
    legalSteps: [
      {
        ...
        description:
          "Register your business at the local Udyam portal — the simplest legal structure for small businesses.",
      ...
      {
        order: 2,
        title: "Bank Current Account",
        description:
          "Open a dedicated business bank account to keep personal and business finances separate.",
        documents: ["Business registration certificate", "Aadhaar", "PAN"],
        estimatedCost: "Free",
        timeframe: "2–5 days",
        authority: "Any nationalized bank",
      },
      {
        order: 3,
        title: "GST Registration (if applicable)",
        description:
          "Required only if annual turnover exceeds ₹20 lakh for services or ₹40 lakh for goods.",
        documents: ["PAN", "Aadhaar", "Business proof"],
        estimatedCost: "Free",
        timeframe: "3–7 days",
        authority: "gst.gov.in",
      },
    ],
    costEstimation: {
      startup: [
        {
          ...
          minCost: idea?.requiredCapital?.min || 5000,
          maxCost: Math.floor((idea?.requiredCapital?.max || 30000) * 0.5),
          currency: "INR",
        },
        {
          item: "Initial stock/materials",
          minCost: 2000,
          maxCost: 10000,
          currency: "INR",
        },
      ...
      monthly: [
        {
          item: "Raw materials / inventory",
          minCost: 5000,
          maxCost: 20000,
          currency: "INR",
        },
        {
          item: "Utilities & packaging",
          minCost: 500,
          maxCost: 2000,
          currency: "INR",
        },
    ...
    marketingBasics: {
      targetCustomers:
        "Local residents and community members within a 5 km radius, aged 20–50.",
      channels: [
        {
          name: "WhatsApp & Local Groups",
          description:
            "Share your product in neighbourhood and community WhatsApp groups and ask for referrals.",
          cost: "Free",
          effectiveness: "high",
        },
        {
          name: "Word of Mouth",
          description:
            "Deliver exceptional quality and ask every satisfied customer for 2 referrals.",
          cost: "Free",
          effectiveness: "high",
        },
        {
          ...
          description:
            "Post photos of your work regularly — consistency builds trust and following.",
          cost: "Free",
          effectiveness: "medium",
        },
        {
          name: "Local Flyers & Pamphlets",
          description:
            "Distribute at temples, markets, and offices near your area.",
          cost: "₹500–2,000",
          effectiveness: "medium",
        },
      ],
      pricingStrategy:
        "Start 10–15% below the market rate to attract your first customers, then raise prices as reviews build up.",
      usp: "Your personal touch, reliability, and local presence are your biggest competitive advantages.",
    },
    milestones: [
      {
        order: 1,
        title: "Market Research Done",
        description: "Spoke to 15+ potential customers",
        targetWeek: 1,
      },
      {
        order: 2,
        title: "First Pilot Customers",
        description: "5 paying trial customers served",
        targetWeek: 2,
      },
      {
        order: 3,
        title: "Legal Setup Complete",
        description: "Udyam registration & bank account",
        targetWeek: 3,
      },
      {
        order: 4,
      ...
      },
      {
        ...
        description: "Revenue covers all monthly costs",
        targetWeek: 10,
      },
      {
        order: 6,
        title: "Scale & Grow",
        description: "Expand capacity or delivery area",
        targetWeek: 16,
      },
    ],
  };
  ...
  if (loading)
    return (
      <div className="py-24">
        <Spinner text="Loading idea details..." />
      </div>
    );
  if (!idea)
    return (
      <div className="text-center py-24 text-slate-500">Idea not found</div>
    );
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap gap-2 mb-3">
              ...
              <span className={`badge ${DIFF_COLORS[idea.difficulty]}`}>
            ...
            <h1 className="text-2xl md:text-3xl font-display font-bold text-slate-900 mb-3 leading-tight">
              {idea.title}
            </h1>
        ...
        <div className="space-y-5 animate-fade-in">
            ...
            <div className="relative pl-8">
              ...
              {rm.milestones.map((m, i) => (
                <div key={i} className="relative mb-5 last:mb-0">
                  <div
                    className={`absolute -left-5 w-4 h-4 rounded-full border-2 border-white shadow-sm ${i === 0 ? "bg-emerald-500" : "bg-slate-200"}`}
                  />
          ...
          <div className="card">
            <h2 className="text-lg font-display font-bold text-slate-900 mb-4 flex items-center gap-2">
              <Wrench size={18} className="text-emerald-600" /> Recommended
              Tools
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {rm.skillsAndTools?.recommendedTools?.map((t, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 p-3.5 bg-slate-50 rounded-xl hover:bg-emerald-50 transition-colors"
                >
      ...
      {activeTab === "roadmap" && (
        <div className="space-y-4 animate-fade-in">
          <div className="card">
            <h2 className="text-lg font-display font-bold text-slate-900 mb-5 flex items-center gap-2">
              <CheckCircle2 size={18} className="text-emerald-600" /> Validation
              Steps
            </h2>
            <div className="space-y-4">
              {rm.validation?.steps?.map((step, i) => (
                <div
                  key={i}
                  className="flex gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-100"
                >
                  <div className="w-9 h-9 bg-emerald-600 text-white rounded-xl flex items-center justify-center text-sm font-bold shrink-0">
                    {step.order}
                  </div>
                  <div>
              ...
              <div className="space-y-2">
                {rm.skillsAndTools.requiredSkills.map((s, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`badge ${s.importance === "must-have" ? "bg-red-100 text-red-700" : "bg-slate-200 text-slate-600"}`}
                    >
                      {s.importance}
                    </span>
                  </div>
      ...
      {activeTab === "costs" && (
        <div className="space-y-5 animate-fade-in">
          <div className="card">
            <h2 className="text-lg font-display font-bold text-slate-900 mb-5 flex items-center gap-2">
              <IndianRupee size={18} className="text-emerald-600" /> Startup
              Cost Estimate
            </h2>
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-5 text-center mb-5 border border-emerald-100">
              ...
              <p className="text-3xl font-display font-bold text-emerald-700">
                ₹{rm.costEstimation?.totalStartupMin?.toLocaleString("en-IN")} –
                ₹{rm.costEstimation?.totalStartupMax?.toLocaleString("en-IN")}
              </p>
            </div>
                ...
                {rm.costEstimation?.startup?.map((item, i) => (
                  ...
                  >
                    ...
                    <td className="py-3 text-right text-slate-600 font-medium">
                      ₹{item.minCost?.toLocaleString("en-IN")}
                    </td>
                    <td className="py-3 text-right text-slate-600 font-medium">
                      ₹{item.maxCost?.toLocaleString("en-IN")}
                    </td>
                  </tr>
                ))}
              </tbody>
                ...
                {rm.costEstimation.monthly.map((item, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-slate-600">
                      ₹{item.minCost?.toLocaleString("en-IN")}–₹
                      {item.maxCost?.toLocaleString("en-IN")}/mo
                    </span>
                  </div>
                ))}
              </div>
        ...
        <div className="space-y-4 animate-fade-in">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3 items-start">
            ...
            <p className="text-sm text-amber-800">
              These are general guidelines. Always consult a local CA or lawyer
      ...
      {activeTab === "marketing" && (
        <div className="space-y-5 animate-fade-in">
          <div className="card">
            <h2 className="text-lg font-display font-bold text-slate-900 mb-4 flex items-center gap-2">
              <Megaphone size={18} className="text-emerald-600" /> Marketing
              Channels
            </h2>
            <div className="space-y-3">
              {rm.marketingBasics?.channels?.map((ch, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex items-start gap-4 p-4 bg-slate-50 rounded-xl hover:bg-emerald-50 transition-colors"
                  >
                    <div
                      className={`shrink-0 mt-0.5 ${EFFECT_COLORS[ch.effectiveness]}`}
                    >
                      <EIcon size={18} />
                    </div>
                    <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="card">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                {rm.marketingBasics?.pricingStrategy}
              </p>
            </div>
            <div className="card">
              <h3 className="font-semibold text-slate-900 mb-2 flex items-center gap-2">
